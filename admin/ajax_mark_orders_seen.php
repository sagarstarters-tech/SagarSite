<?php
/**
 * AJAX Mark Orders Seen
 * Location: /admin/ajax_mark_orders_seen.php
 */
...
if (isset($conn)) {
    ...
    if ($res && $row = $res->fetch_assoc()) {
        ...
        if ($latest_id > 0) {
            $stmt = $conn->prepare("INSERT INTO settings (setting_key, setting_value) VALUES ('admin_last_seen_order_id', ?) ON DUPLICATE KEY UPDATE setting_value = VALUES(setting_value)");
            if ($stmt) {
