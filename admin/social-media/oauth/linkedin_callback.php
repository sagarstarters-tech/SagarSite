...
try {
    ...
    // Mock LinkedIn save
    $stmt = $pdo->prepare("INSERT INTO sm_connected_accounts (platform, account_id, access_token, account_name, is_active) VALUES ('linkedin', 'li_mock_id', 'mock_token', 'LinkedIn Page', 1) ON DUPLICATE KEY UPDATE access_token = VALUES(access_token), is_active = 1");
    $stmt->execute();
